...
public class C02_ReadExcel {
    ...
    public void test01() throws IOException {
        String dosyaYolu = "src/test/java/tests/day11_excellOtomasyonu/ulkeler.xlsx";
        ...
        for (int i = 0; i <= sayfa1.getLastRowNum(); i++) {
            ...
            if (satirdakiUlkeIsmi.equals("Togo")) {
                flag = true;
                System.out.println("Excell`de Togo var");
                break;
            }
        }
        ...
        Map<String,String> ulkeIsimleriMap = new HashMap<>();
        for (int i = 0; i <= sayfa1.getLastRowNum(); i++) {
